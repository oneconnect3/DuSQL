...
def init_arg_parser():
    ...
    arg_parser.add_argument('--lr_scheduler', default=True, help='use learning rate scheduler')
    ...
    arg_parser.add_argument('--glove_embed_path', default="data/cc.zh.300.vec.filter", type=str)
    arg_parser.add_argument('--load_model', default='saved_model/1588038530/test_model.model', type=str, help='load a pre-trained model')
    #arg_parser.add_argument('--glove_embed_path', default="../../en_embedding/glove.42B.300d.txt", type=str)

    arg_parser.add_argument('--batch_size', default=4, type=int, help='batch size')
