...
class Grammar(object):
    def __init__(self, is_sketch=False):
        ...
        self.type_id += 1
        self.type2id[Value] = self.type_id
        #self.type_id += 1
        #self.type2id[MathAgg] = self.type_id
...
class SQL(Action):
    ...
    def _init_grammar(self):
        ...
        self.grammar_dict = {
            0: 'SQL intersect SingleSQL SingleSQL',
            1: 'SQL union SingleSQL SingleSQL',
            2: 'SQL except SingleSQL SingleSQL',
            3: 'SQL + SingleSQL SingleSQL',
            4: 'SQL - SingleSQL SingleSQL',
            5: 'SQL * SingleSQL SingleSQL',
            6: 'SQL / SingleSQL SingleSQL',
            7: 'SQL SingleSQL',
        }
        self.production_id = {}
...
class Agg(Action):
    ...
    def __repr__(self):
        return 'Agg(' + str(self.grammar_dict[self.id_c].split(' ')[1]) + ')'
